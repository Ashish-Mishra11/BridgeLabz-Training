// Writing a java code to find the sum of n natural numbers using while loop
// Create NaturalNumberSum class to find the sum of n natural numbers using while loop
...
public class NaturalNumberSum {
  public static void main(String[] args) {
    ...
    if(number > 0) {
      ...
      while(number > 0) {
        // Create variable total2 to store the total value calculated through while loop
        total2 +=number;
        number--;
      }
    }
    ...
    System.out.println("The total through formula is " + total1 + " and the total through while loop is " + total2 + "\nHence the total of natural number is " + total1 );
