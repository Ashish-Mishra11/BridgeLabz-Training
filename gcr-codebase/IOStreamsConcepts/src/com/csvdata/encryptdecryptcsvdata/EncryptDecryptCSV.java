package com.csvdata.encryptdecryptcsvdata;
...
public class EncryptDecryptCSV {
	...
	// sample file path
	String inputFile = "src/com/csvdata/csvfiles/normal.csv";
	String encryptedFile = "src/com/csvdata/csvfiles/encript.csv";
	...
	// sample file path
	String encryptedFile ="src/com/csvdata/csvfiles/normal.csv";
	String decryptedFile =  "src/com/csvdata/csvfiles/encript.csv";
